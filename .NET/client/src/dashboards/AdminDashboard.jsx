  ...
  useEffect(() => {
    if (activeTab === 'reports' && user) {
      setSystemReport({
        ...
        totalCarbonSaved: systemStats.totalWasteCollected * 0.5,
        usersByRole: {
          ...
          <div className="report-section">
            ...
            <div className="report-stats">
              ...
              <div className="report-stat">
                ...
                <strong>{systemReport.totalWasteCollected} kg</strong>
              </div>
              <div className="report-stat">
                <span>Carbon Saved:</span>
                <strong>{systemReport.totalCarbonSaved} kg CO₂</strong>
              </div>
            </div>
          </div>
