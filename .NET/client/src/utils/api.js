...
export const collectorAPI = {
  ...
  getAllRequests: () => api.get('/collector/available-pickups'),
  getMyRequests: () => api.get('/collector/pickups'),
  acceptRequest: (requestId) => api.post(`/collector/pickup/${requestId}/accept`),
  rejectRequest: (requestId) => api.post(`/collector/pickup/${requestId}/reject`),
  completeRequest: (requestId, completionData) => api.post(`/collector/pickup/${requestId}/waste`, completionData),
  updateLocation: (locationData) => api.post('/collector/location', locationData),
  generateBill: (requestId, billData) => api.post(`/collector/pickup/${requestId}/generate-bill`, billData),
};
